...
function updateCartUI() {
  ...
  cart.forEach((item, index) => {
    ...
    totalDisp.innerHTML = `
        ...
        <div style="display:flex; justify-content:space-between; font-size:18px; color:#ff0000; font-weight:bold; border-top:1px solid #444; pt-5px;">
            <span>الإجمالي:</span>
